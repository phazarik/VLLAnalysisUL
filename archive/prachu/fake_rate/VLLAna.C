...
#include "/home/work/phazarik1/work/VLLanalysis/VLLAnalysisUL/setup/anaCodesetup/FakeRate.h"
...
void VLLAna::SlaveTerminate()
{
  ...
  cout<<"nEvt (photon+loose) = "<< n_pho_loose_evt <<endl;
  cout<<"nEvt (photon+tight) = "<< n_pho_tight_evt <<endl;
  if(n_pho_loose_evt>0)
    cout<<"Avg fakerate = "<< (float)n_pho_tight_evt/n_pho_loose_evt <<endl;
...
void VLLAna::BookHistograms()
{
  ...
  //#####################
  // FakeRate measurement
  //#####################
  h.fakerate[0] = new TH1F("Muon_cand_Pt", "Muon Candidate Pt", 500, 0, 500);
  h.fakerate[1] = new TH1F("Muon_cand_Eta", "Muon Candidate Eta", 100, -4, 4);
  h.fakerate[2] = new TH1F("Muon_cand_iso04", "Muon Candidate iso04", 200, 0, 1);
  h.fakerate[3] = new TH1F("Muon_cand_looseId", "Muon Candidate looseId", 5, -1, 4);
  h.fakerate[4] = new TH1F("Muon_cand_tightId", "Muon Candidate tightId", 5, -1, 4);
  h.fakerate[5] = new TH1F("Muon_cand_dxy", "Muon Candidate dxy", 100, 0, 0.1);
  h.fakerate[6] = new TH1F("Muon_cand_dz", "Muon Candidate dz", 100, 0, 1);
  h.fakerate[7] = new TH1F("nPhoton", "No of Photons", 10, 0, 10);
  h.fakerate[8] = new TH1F("nlooseObj", "No of loose objects", 10, 0, 10);
  h.fakerate[9] = new TH1F("ntightObj", "No of tight objects", 10, 0, 10);
