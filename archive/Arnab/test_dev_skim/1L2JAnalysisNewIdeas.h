...
void VLLAna::Analysis(){
  ...
  //SignalRegion
  bool l2jSelection_signalCut=(dijetMass<200);
  bool l2jSelection_SR=l2jSelection_primaryCut && l2jSelection_signalCut;
  
  //ControlRegion
  bool l2jSelection_wjet_bkg= (!l2jSelection_signalCut)&&(mtlep0>50)&&(l2jSelection_global);
  bool l2jSelection_qcd_bkg = (!l2jSelection_signalCut)&&(mtlep0<50)&&(l2jSelection_global);
  ...
  if(MuonChannel){
    ...
    //ABCD Method(WJets)
    bool regA=l2jSelection_wjet_bkg && dijetMass<400 && (mtlep0<150);
    bool regB=l2jSelection_wjet_bkg && dijetMass<400 && (mtlep0>150);
    bool regC=l2jSelection_wjet_bkg && dijetMass>400 && (mtlep0<150); 
    bool regD=l2jSelection_wjet_bkg && dijetMass>400 && (mtlep0>150);
