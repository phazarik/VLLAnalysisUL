...
Bool_t VLLAna::Process(Long64_t entry)
{
  ...
  if(GoodEvt){
	...
	evtwt=1.0;
      ...
      //-----------------------------------------------------------------------------------------------------------------------
      //                                          For Sourabh:July 18 2022                                                    |
      //-----------------------------------------------------------------------------------------------------------------------
      //Single Muon events with Pt cut like 20 GeV/30 GeV
      //Plot mT with PF MET and PUPPI MET and overlay them
      //We can also require MET>30 GeV to make the plot look nicer

      //PUPPI MET
      puppimetpt = *PuppiMET_pt;
      puppimetphi = *PuppiMET_phi;
      
      if(llep.size()>0){//atleast one lepton
	if(abs(llep[0].id)==13){//leading muon selected(muons are medium ID,Isolated,minPT>10)
	  if(llep[0].v.Pt()>30){//pt cut on muon
	    float mtlep_PF = sqrt(2.0*llep[0].v.Pt()*metpt*(1-cos(delta_phi(llep[0].v.Phi(),metphi))));              //Leading Lepton MT with PFMET
	    float mtlep_Puppi = sqrt(2.0*llep[0].v.Pt()*puppimetpt*(1-cos(delta_phi(llep[0].v.Phi(),puppimetphi))));  //Leading Lepton MT with PuppiMET
	    
	    //without met cut
	    h.sourabh[0]->Fill(mtlep_PF);
	    h.sourabh[1]->Fill(mtlep_Puppi);
	    //with met cut
	    if(metpt>30){h.sourabh[2]->Fill(mtlep_PF);}
	    if(puppimetpt>30){h.sourabh[3]->Fill(mtlep_Puppi);}
	  }
	}
      }
...
void VLLAna::BookHistograms()
{
  ...
  */
  ...
  /*h.vllplotl2j[0]=new TH1F("ptlep0_l2j","Lepton PT",1000,0,1000);
  h.vllplotl2j[1]=new TH1F("ptjet0_l2j","Leading Jet PT",1000,0,1000);
  h.vllplotl2j[2]=new TH1F("ptjet1_l2j","SubLeading Jet PT",1000,0,1000);
  h.vllplotl2j[3]=new TH1F("mtlep0_l2j","Lepton MT",1000,0,1000);
  h.vllplotl2j[4]=new TH1F("mtjet0_l2j","Leading Jet MT",1000,0,1000);
  h.vllplotl2j[5]=new TH1F("mtjet1_l2j","SubLeading Jet MT",1000,0,1000);
  h.vllplotl2j[6]=new TH1F("dijetmass_l2j","Dijet Inv Mass",1000,0,1000);
  h.vllplotl2j[7]=new TH1F("drjet01_l2j","DR(jet0,jet1)",100,0,10);  
  h.vllplotl2j[8]=new TH1F("dijetPT_l2j","Dijet System PT",1000,0,1000);
  h.vllplotl2j[9]=new TH1F("dijetMT_l2j","Dijet System MT",1000,0,1000);
  h.vllplotl2j[10]=new TH1F("MET_l2j","MET in 1L2J events",1000,0,1000);
  h.vllplotl2j[11]=new TH1F("HT_l2j","HT in 1L2J events",1000,0,1000);
  h.vllplotl2j[12]=new TH1F("ST_l2j","ST in 1L2J events",1000,0,1000);
  h.vllplotl2j[13]=new TH1F("njet_l2j","No of jets in 1L2J events",10,0,10);
  h.vllplotl2j[14]=new TH1F("nbjet_l2j","No of b-jets in 1L2J events",10,0,10);
  h.vllplotl2j[15]=new TH1F("dphimetjet0_l2j","dPhi between jet0 and met in 1L2J events",100,0,10);
  h.vllplotl2j[16]=new TH1F("dphimetjet1_l2j","dPhi between jet1 and met in 1L2J events",100,0,10);
  h.vllplotl2j[17]=new TH1F("dphimetlep0_l2j","dPhi between lep0 and met in 1L2J events",100,0,10);
  h.vllplotl2j[18]=new TH1F("dphijet0lep0_l2j","dPhi between jet0 and lep in 1L2J events",100,0,10);
  h.vllplotl2j[19]=new TH1F("dphijet1lep0_l2j","dPhi between jet1 and lep in 1L2J events",100,0,10);
  h.vllplotl2j[20]=new TH1F("dphidijetlep0_l2j","dPhi between lep0 and dijet system in 1L2J events",100,0,10);
  h.vllplotl2j[21]=new TH1F("dphimetdijet_l2j","dPhi between met and dijet system in 1L2J events",100,0,10);
  for(int i=0;i<22;i++)h.vllplotl2j[i]->Sumw2();
  */
