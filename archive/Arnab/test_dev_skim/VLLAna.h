...
public :
  ...
  //TTreeReaderArray<Int_t> Jet_nConstituents = {fReader, "Jet_nConstituents"};   //NanoAODv8
  ...
  //Analysis 2L Functions(2LAnalysis.h header file)
  void Book2LAnalysisHistograms();
  void Analysis2L();
...
private:
  ...
  int nEvtTotal,nEvtRan,nEvtTrigger,n3L,n3LonZ,n_mu_anlys,n_mu_NNScore,n_mu_bfake,n_mu_prompt,n_mu_bfake_flav,n_bfake_matching,n_ttbarcr,n_ttbar2Lplus1Fake,n_ll,n_lt,n_tt,n_l2j,n_l2j_vetolooselep;
