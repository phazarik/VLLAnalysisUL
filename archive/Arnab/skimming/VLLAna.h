...
public :
  ...
  */
  ...
  //HLT TRIGGER
  //Electron Trigger
  TTreeReaderValue<Bool_t> HLT_Ele27_WPTight_Gsf = {fReader, "HLT_Ele27_WPTight_Gsf"};    //Tight 27 GeV Electron
  TTreeReaderValue<Bool_t> HLT_Ele32_WPTight_Gsf = {fReader, "HLT_Ele32_WPTight_Gsf"};    //Tight 32 GeV Electron
  //Muon Trigger
  ...
  TTreeReaderValue<Bool_t> HLT_IsoMu24 = {fReader, "HLT_IsoMu24"};                        // IsoMu24
  TTreeReaderValue<Bool_t> HLT_IsoMu27 = {fReader, "HLT_IsoMu27"};                        // IsoMu27
  ...
  //TTreeReaderValue<Bool_t> HLT_IsoTkMu24 = {fReader, "HLT_IsoTkMu24"};                    //IsoTrackMu24
  //TTreeReaderValue<Bool_t> HLT_IsoTkMu27 = {fReader, "HLT_IsoTkMu27"};                    //IsoTrackMu27
...
private:
  ...
  TFile *_HstFile,*_mvaFile,*_SkimFile;
  TTree *tree,*skimTree;
  ...
  int n3L,n3LonZ,n_mu_anlys,n_mu_NNScore,n_mu_bfake,n_mu_prompt,n_mu_bfake_flav,n_bfake_matching,n_ttbarcr,n_ttbar2Lplus1Fake,n_ll,n_lt,n_tt,n_l2j;
